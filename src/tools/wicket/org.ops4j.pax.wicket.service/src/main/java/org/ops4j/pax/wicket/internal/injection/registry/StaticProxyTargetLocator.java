 ...
 * @version $Id: $Id
 */
public class StaticProxyTargetLocator implements ProxyTargetLocator, Serializable {
    ...
    private static class StaticProxyTarget implements ProxyTarget, Serializable{
