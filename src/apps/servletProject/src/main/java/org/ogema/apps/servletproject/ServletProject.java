 ...
 */
package org.ogema.apps.servletproject;
...
public class ServletProject implements Application {
	...
	public void start(ApplicationManager appManager) {
		...
		logger.debug("{} started", getClass().getName());
                ...
                String webResourcePackage = "org.ogema.apps.servletproject";
                webResourcePackage = webResourcePackage.replace(".", "/");

                String appNameLowerCase = "ServletProject";
                ...
                ServletProjectServlet servlet = new ServletProjectServlet(appMan);
...
//				servlet);
                ...
                System.out.println(appManager.getWebAccessManager().registerWebResourcePath("/", webResourcePackagePath));
                System.out.println(appManager.getWebAccessManager().registerWebResourcePath("servlet", servlet));

	}

        @Override
	public void stop(AppStopReason reason) {
		appMan.getWebAccessManager().unregisterWebResource("/org/ogema/apps/servletproject/test");
		appMan.getWebAccessManager().unregisterWebResource("/org/ogema/apps/servletproject/servlet");
	}
