...
public class GraphGenServlet extends HttpServlet {
	...
	public GraphGenServlet(ResourceAccess resAcc, SerializationManager serializationManager, OgemaLogger logger) {
		this.resAcc = resAcc;
		this.serMan = serializationManager;
		this.logger = logger;
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "visjs":
			...
			break;
		case "graphviz":
			generator = new GraphwizGenerator(logger);
			break;
		}
