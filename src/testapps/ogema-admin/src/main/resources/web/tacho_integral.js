...
function integral(ctx0,ctx1,iValueMin, iValueMax, iX, iY,picsrc,iconsrc,title,tb) {
	...
	this.setValue = function(val){
		value=val
		sum=sum+value*timebase
		context1.clearRect(0,instrbuttom,context1.canvas.width,context1.canvas.height-instrbuttom);
		context1.fillText(Math.round(sum/36)/100+"Wh",canvas_w/2,instrbuttom+30,canvas_w);
	}
	...
	function drawValue(iValue) {
		context1.clearRect(0,0,context1.canvas.width,instrbuttom);
