...
/**
 * Helper class wrapping all serial port communication parameters. Very similar to the javax.comm demos, however, not
 * the same.
 * 
...
public class SerialParameters {
	...
	/**
	 * Constructs a new <tt>SerialParameters</tt> instance with parameters obtained from a <tt>Properties</tt> instance.
	 * 
	 * @param props
	 *            a <tt>Properties</tt> instance.
	 * @param prefix
	 *            a prefix for the properties keys if embedded into other properties.
	 */
	...
	/**
	 * Sets the type of flow control for the input as given by the passed in <tt>int</tt>.
	 * 
	 * @param flowcontrol
	...
	/**
	 * Sets the type of flow control for the input as given by the passed in <tt>String</tt>.
	 * 
	 * @param flowcontrol
	...
	/**
	 * Sets the output flow control type as given by the passed in <tt>String</tt>.
	 * 
	 * @param flowControlOut
	...
	/**
	 * Sets the receive timeout for the serial communication parsing the given String using
	 * <tt>Integer.parseInt(String)</tt>.
	 * 
	 * @param str
	...
	/**
	 * Converts an <tt>int</tt> describing a flow control type to a String describing a flow control type.
	 * 
	 * @param flowcontrol
	...
	/**
	 * Populates the settings from an <tt>Proper</tt> that reads from a properties file or contains a set of properties.
	 * 
	 * @param in
	 *            the <tt>InputStream</tt> to read from.
	 * 
	 *            private void loadFrom(InputStream in) throws IOException { Properties props = new Properties();
	 *            props.load(in); setPortName(props.getProperty("portName"));
	 *            setBaudRate(props.getProperty("baudRate")); setFlowControlIn(props.getProperty("flowControlIn"));
	 *            setFlowControlOut(props.getProperty("flowControlOut")); setParity(props.getProperty("parity"));
	 *            setDatabits(props.getProperty("databits")); setStopbits(props.getProperty("stopbits"));
