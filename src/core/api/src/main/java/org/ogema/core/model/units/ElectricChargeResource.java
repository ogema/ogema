...
/**
 * Resource representing an electric charge physical value.
 */
public interface ElectricChargeResource extends PhysicalUnitResource {
	...
	/**
	 * Sets the charge to a new value. Unit is Ampere-hours.
	 *
	 * @see FloatResource#getValue()
	 */
	@Override
