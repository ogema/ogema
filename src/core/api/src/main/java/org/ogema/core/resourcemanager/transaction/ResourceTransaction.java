...
public interface ResourceTransaction {
	 ...
	 * 		If a resource is inactive and a read operation with type {@link ReadConfiguration#FAIL} is
	 * 		performed, or a write operation with type {@link WriteConfiguration#FAIL}.
	 */
	 ...
	 * will be thrown. See {@link TransactionFuture#getValue()}.
	 * @param configuration
