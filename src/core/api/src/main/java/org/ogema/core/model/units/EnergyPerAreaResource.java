 ...
 */
public interface EnergyPerAreaResource extends PhysicalUnitResource {

	/**
	 * Returns the energy density in Watt per square meter.
	 *
	...
	/**
	 * Sets the energy density to a new value. Unit is Watt per square meter.
	 *
	 * @see FloatResource#getValue()
	 */
	@Override
