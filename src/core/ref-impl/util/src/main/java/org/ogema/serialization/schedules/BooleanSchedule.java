...
public class BooleanSchedule extends JaxbSchedule<Boolean> {
	...
	public BooleanSchedule(Resource res, SerializationStatus status) {
		super(res, status);
	}

	public BooleanSchedule(Resource res, SerializationStatus serStat, long start, long end) {
		super(res, serStat, start, end);
	}
