...
public class OgemaSVGPanelMini extends Panel {

	private static final long serialVersionUID = -6837143153127468974L;

	public OgemaSVGPanelMini(String id, int x, int y, float width, float height, String viewBox, String enableBackground) {
		super(id);
