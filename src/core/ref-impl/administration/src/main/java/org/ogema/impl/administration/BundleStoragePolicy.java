...
class BundleStoragePolicy extends BundleTracker<Bundle> implements BundleStorage {
	...
	BundleStoragePolicy(BundleContext context, int mask, BundleTrackerCustomizer<Bundle> cust) {
