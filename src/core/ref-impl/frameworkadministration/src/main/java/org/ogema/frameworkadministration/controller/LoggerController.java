...
public class LoggerController {
	...
	/**
	 * Generates a list of all OGEMA loggers as json. See {@link org.ogema.frameworkadministration.json.get.LoggerJsonGetList} for message format.
	 ...
	 * @param loggerJsonPost json message. See {@link org.ogema.frameworkadministration.json.post.LoggerJsonPost} for message format.
	 */
