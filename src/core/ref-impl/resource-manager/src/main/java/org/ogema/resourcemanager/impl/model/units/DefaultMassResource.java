 ...
 */
public class DefaultMassResource extends UnitFloatResource implements MassResource {

	public DefaultMassResource(VirtualTreeElement el, Class<? extends Resource> unitResourceType, String path,
