 ...
 */
public class DefaultVolumeResource extends UnitFloatResource implements VolumeResource {

	public DefaultVolumeResource(VirtualTreeElement el, Class<? extends Resource> unitResourceType, String path,
	...
	public final PhysicalUnit getUnit() {
		return PhysicalUnit.CUBIC_METERS;
	}
}
