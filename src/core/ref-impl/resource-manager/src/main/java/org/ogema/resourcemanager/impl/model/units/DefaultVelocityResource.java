 ...
 */
public class DefaultVelocityResource extends UnitFloatResource implements VelocityResource {

	public DefaultVelocityResource(VirtualTreeElement el, Class<? extends Resource> unitResourceType, String path,
	...
	public final PhysicalUnit getUnit() {
		return PhysicalUnit.METERS_PER_SECOND;
	}
}
