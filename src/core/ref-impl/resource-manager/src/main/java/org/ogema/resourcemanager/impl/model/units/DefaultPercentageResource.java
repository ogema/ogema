 ...
 *
 */
public class DefaultPercentageResource extends UnitFloatResource implements PercentageResource {

	public DefaultPercentageResource(VirtualTreeElement el, Class<? extends Resource> unitResourceType, String path,
