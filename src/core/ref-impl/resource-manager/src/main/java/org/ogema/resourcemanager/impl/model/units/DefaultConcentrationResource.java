 ...
 */
public class DefaultConcentrationResource extends UnitFloatResource implements ConcentrationResource {

	public DefaultConcentrationResource(VirtualTreeElement el, Class<? extends Resource> unitResourceType, String path,
	...
	public final PhysicalUnit getUnit() {
		return PhysicalUnit.PARTS_PER_MILLION;
	}
}
