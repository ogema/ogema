 ...
 */
public class DefaultFrequencyResource extends UnitFloatResource implements FrequencyResource {

	public DefaultFrequencyResource(VirtualTreeElement el, Class<? extends Resource> unitResourceType, String path,
