 ...
 */
public class DefaultElectricChargeResource extends UnitFloatResource implements ElectricCurrentResource {

	public DefaultElectricChargeResource(VirtualTreeElement el, Class<? extends Resource> unitResourceType, String path,
	...
	public final PhysicalUnit getUnit() {
		return PhysicalUnit.AMPERE_HOURS;
	}
}
