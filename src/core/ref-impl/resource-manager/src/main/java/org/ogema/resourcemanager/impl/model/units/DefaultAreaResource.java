 ...
 */
public class DefaultAreaResource extends UnitFloatResource implements AreaResource {

	public DefaultAreaResource(VirtualTreeElement el, Class<? extends Resource> unitResourceType, String path,
	...
	public final PhysicalUnit getUnit() {
		return PhysicalUnit.SQUARE_METERS;
	}
}
