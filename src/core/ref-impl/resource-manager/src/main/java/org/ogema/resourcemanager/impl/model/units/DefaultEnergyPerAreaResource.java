 ...
 */
public class DefaultEnergyPerAreaResource extends UnitFloatResource implements EnergyPerAreaResource {

	public DefaultEnergyPerAreaResource(VirtualTreeElement el, Class<? extends Resource> unitResourceType, String path,
	...
	public final PhysicalUnit getUnit() {
		return PhysicalUnit.WATT_PER_SQUARE_METER;
	}
}
