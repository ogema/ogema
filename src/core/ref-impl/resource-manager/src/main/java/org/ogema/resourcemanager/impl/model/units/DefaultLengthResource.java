 ...
 */
public class DefaultLengthResource extends UnitFloatResource implements LengthResource {

	public DefaultLengthResource(VirtualTreeElement el, Class<? extends Resource> unitResourceType, String path,
