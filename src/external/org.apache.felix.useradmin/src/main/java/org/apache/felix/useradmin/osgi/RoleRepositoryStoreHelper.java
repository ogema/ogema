 ...
 * <p>
 * This helper allows us to use {@link RoleRepositoryStore} without having to worry about the possible absence of the
 * actual store implementation.
 * </p>
 */
class RoleRepositoryStoreHelper extends ServiceTracker implements RoleRepositoryStore {
	 ...
	 */
	private RoleRepositoryStore getStore() throws InterruptedException {
