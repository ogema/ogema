...
public class TestDeviceLocator implements DeviceLocator {
	...
	public TestDeviceLocator(String driverName, String interfaceName, String deviceAddress, String parameters) {
	...
	public int hashCode() {
		int hash = 3;
		hash = 59 * hash + Objects.hashCode(this.driverName);
		hash = 59 * hash + Objects.hashCode(this.interfaceName);
		hash = 59 * hash + Objects.hashCode(this.deviceAddress);
		return hash;
	}
